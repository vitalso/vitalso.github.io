  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'long': '-8px 9px 26px 0 rgba(0, 0, 0, 0.1) , -32px 36px 48px 0 rgba(0, 0, 0, 0.09) , -72px 80px 65px 0 rgba(0, 0, 0, 0.05) , -128px 142px 76px 0 rgba(0, 0, 0, 0.01) , -200px 222px 84px rgba(0, 0, 0, 0)'
      }
    },
    ...
    backgroundImage: {
      ...
      'lg-hero-section': "url('../assets/bg-lg-line.svg') , linear-gradient(180deg, rgba(210, 238, 253, 1), rgba(243, 242, 248, 1), rgba(251, 251, 252, 1)) ",
