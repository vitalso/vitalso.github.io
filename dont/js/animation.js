...
.add({
    ...
    keyframes: [
        ...
        {translateX: -3600 , translateY: -120 , rotate: 3 },
    ],
}, 0)
.add({
    ...
    keyframes: [
        ...
        {translateX: -4000 , translateY: -120 , rotate: -3 },
    ],
}, 0)
...
.add({
    ...
    keyframes: [
        ...
        { scale: 0 , opacity: 0 },
        { translateY: -967} ,
        { duration: 10, delay: 400, scale: 1 , opacity: 1 },
        { delay: 1000 , translateY: -880 , width: '4700px'},
        //{ delay: 1000 , width: '4700px'},
        { delay: 300 , translateX: -2540 },
        { delay: 500 , translateX: -3440 },
        { delay: 500 , translateX: -3480 },
        { delay: 500 , translateY: -967 },
