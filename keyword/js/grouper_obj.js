let objGrouper = {
    ...
    makePreviewPage()
    {
        ...
        $('#newAdGroupsNumber').html(objGrouper.result['grouper']['groups'].length);
    ...
    makeConfirmPage()
    {
        ...
        if (objGrouper.result.adGroup) {
            alerts.push(
                ...
                'with <span class="accent">' + objGrouper.result.updated.groupedPhrases.length + '</span> keywords.'
            );
        ...
        alerts.push(
            ...
            ' ' +
            objGrouper.result.updated.notGroupedPhrases.length +
            ...
            '<div class="drag-card parent-remove">' +
                '<div class="drag-top-info">' +
                    '<span class="group-number-container">' +
                        '<span class="group-number">Add new group ' + index + '</span> ' +
