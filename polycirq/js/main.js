$(function () {
  ...
  $('.our-mission .btn-collapse').on('click' , function(){
    $(this).toggleClass('is-open');
  });

  $('.switch input[type="checkbox"]').change(function(){
    if ( $(this).prop("checked") ) {
      $('.toggle-img.d-none').removeClass('d-none');
      $('.toggle-img').eq(0).addClass('d-none');
    } else {
      $('.toggle-img.d-none').removeClass('d-none');
      $('.toggle-img').eq(1).addClass('d-none');
    }
  });
